...
export default function Sidebar() {
  ...
  const { currentRole, organization } = useSunuGestion();
  ...
  let navItems = [
    ...
    { label: 'Maintenance & Tickets', href: '/app/maintenance', icon: Wrench },
  ...
  if (currentRole === 'PROPRIETAIRE') {
    ...
    navItems = [
      ...
      { label: 'Signaler une Panne', href: '/tenant/maintenance', icon: Wrench },
    ];
  ...
  return (
    <aside className="w-64 bg-slate-900 text-slate-100 flex flex-col min-h-screen border-r border-slate-800 shrink-0 sticky top-0 h-screen z-30 shadow-2xl overflow-y-auto">
      {/* Brand Header */}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div className="truncate">
              ...
              <p className="text-[10px] text-slate-400 truncate">Sunu Gestionbilier</p>
            </div>
          </div>
          <Link href="/" title="Déconnexion" className="text-slate-400 hover:text-rose-400 transition-colors p-1.5 rounded-md hover:bg-slate-800">
